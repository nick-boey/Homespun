...
public class TaskGraphTextRendererTests
{
    ...
    public void Render_MockIssueData_MatchesExpectedOutput()
    {
        ...
        // ISSUE-006 and ISSUE-010 are now actionable in v1.7.0's new algorithm
    ...
    public void Render_MockIssueData_NextIssuesAreActionable()
    {
        ...
        // Actionable issues per Fleece.Core v1.7.0 - new algorithm marks leaf-accessible issues as actionable
        // ISSUE-001, ISSUE-002 are orphans (no parents) and Open status
        // ISSUE-006 and ISSUE-010 are now actionable in v1.7.0's updated algorithm
