...
/// </summary>
public partial class SystemPromptService
{
    private readonly TreeAgentDbContext _db;
    private readonly FeatureService _featureService;

    public SystemPromptService(TreeAgentDbContext db, FeatureService featureService)
    {
        _db = db;
    ...
    {
        var features = await _featureService.GetTreeAsync(projectId);
    ...
    {
        var siblings = await _db.Features
