...
describe('calculateDiff', () => {
  it('identifies prompts to create (name not in current set)', () => {
  ...
  it('identifies prompts to update (matching name, different content)', () => {
    const current: ExportedPrompt[] = [
      { name: 'My Prompt', initialMessage: 'Old message', mode: SessionMode.BUILD },
    ]
    const edited: ExportedPrompt[] = [
      { name: 'My Prompt', initialMessage: 'New message', mode: SessionMode.PLAN },
    ]
