...
const TodoIcon = memo(function TodoIcon({ status }: { status: PlanTodoStatus }) {
  ...
  if (status === 'completed') {
    return (
      <span
        className="border-primary bg-primary motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 flex size-6 shrink-0 items-center justify-center rounded-full border shadow-sm motion-safe:duration-300 motion-safe:ease-out"
        aria-hidden="true"
      >
        <Check
          className="text-primary-foreground motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:fill-mode-both size-4 motion-safe:delay-75 motion-safe:duration-200"
          strokeWidth={3}
        />
      </span>
    )
  ...
  if (status === 'cancelled') {
    return (
      <span
        className="border-destructive bg-destructive motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 flex size-6 shrink-0 items-center justify-center rounded-full border shadow-sm motion-safe:duration-300 motion-safe:ease-out dark:border-red-600 dark:bg-red-600"
        aria-hidden="true"
      >
        <X
          className="motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:fill-mode-both size-4 text-white motion-safe:delay-75 motion-safe:duration-200"
          strokeWidth={3}
        />
      </span>
    )
      ...
      <Collapsible asChild open={isOpen} onOpenChange={setIsOpen}>
        ...
        >
          ...
          <CollapsibleContent className="group/content" data-slot="collapsible-content">
            <div className="motion-safe:group-data-[state=closed]/content:animate-out motion-safe:group-data-[state=closed]/content:fade-out motion-safe:group-data-[state=closed]/content:slide-out-to-top-1 motion-safe:group-data-[state=open]/content:animate-in motion-safe:group-data-[state=open]/content:fade-in motion-safe:group-data-[state=open]/content:slide-in-from-top-1 motion-safe:group-data-[state=open]/content:fill-mode-both min-w-0 motion-safe:group-data-[state=closed]/content:duration-150 motion-safe:group-data-[state=open]/content:delay-75 motion-safe:group-data-[state=open]/content:duration-150">
