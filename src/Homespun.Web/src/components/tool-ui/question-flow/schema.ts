...
export const parseSerializableQuestionFlow: (input: unknown) => SerializableQuestionFlow =
  SerializableQuestionFlowSchemaContract.parse

export const safeParseSerializableQuestionFlow: (
  input: unknown
) => SerializableQuestionFlow | null = SerializableQuestionFlowSchemaContract.safeParse
