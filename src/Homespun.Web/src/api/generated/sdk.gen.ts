...
import type {
  ...
  PostApiOtlpV1LogsData,
  PostApiOtlpV1LogsResponses,
  PostApiOtlpV1TracesData,
  PostApiOtlpV1TracesResponses,
...
export class Models {
  public static getApiModels<ThrowOnError extends boolean = false>(
    options?: Options<GetApiModelsData, ThrowOnError>
  ) {
    return (options?.client ?? client).get<GetApiModelsResponses, unknown, ThrowOnError>({
      url: '/api/models',
      ...options,
    })
  }
...
export class OtlpReceiver {
  public static postApiOtlpV1Logs<ThrowOnError extends boolean = false>(
    options?: Options<PostApiOtlpV1LogsData, ThrowOnError>
  ) {
    return (options?.client ?? client).post<PostApiOtlpV1LogsResponses, unknown, ThrowOnError>({
      url: '/api/otlp/v1/logs',
      ...options,
    })
  }

  public static postApiOtlpV1Traces<ThrowOnError extends boolean = false>(
    options?: Options<PostApiOtlpV1TracesData, ThrowOnError>
  ) {
    return (options?.client ?? client).post<PostApiOtlpV1TracesResponses, unknown, ThrowOnError>({
