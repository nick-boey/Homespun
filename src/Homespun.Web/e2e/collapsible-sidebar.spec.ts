...
test.describe('Collapsible Sidebar', () => {
  test.skip('inline detail is collapsed by default', async ({ page }) => {
    // This test requires specific UI selectors to be implemented
    // Skipped until selectors are verified
  })

  test.skip('keyboard navigation does not expand row', async ({ page }) => {
    // This test requires specific UI selectors to be implemented
    // Skipped until selectors are verified
  })

  test.skip('double clicking issue expands row', async ({ page }) => {
    // This test requires specific UI selectors to be implemented
    // Skipped until selectors are verified
  })

  test.skip('double clicking expanded issue collapses row', async ({ page }) => {
    // This test requires specific UI selectors to be implemented
    // Skipped until selectors are verified
  })

  test.skip('escape key collapses expanded row', async ({ page }) => {
    // This test requires specific UI selectors to be implemented
    // Skipped until selectors are verified
  })
